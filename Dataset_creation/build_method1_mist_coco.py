...
def main():
    ...
    for ci, class_name in enumerate(classes):
        ...
        for split_name, start, end in [
            ...
            retain_dir = os.path.join(args.output_root, "images", split_name, "retain", class_name)
            forget_dir = os.path.join(args.output_root, "images", split_name, "forget", class_name)
            forget_neg_dir = os.path.join(args.output_root, "images", split_name, "forget_neg", class_name)
            ...
            print(f"[MIST][{split_name}][{class_name}] retain={saved_pos} forget={saved_pos} forget_neg={saved_neg}")
